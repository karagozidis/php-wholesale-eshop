...
class ModelCatalogOption extends Model {
	public function addOption($data) {
		 $this->db->query("INSERT INTO `" . DB_PREFIX . "option` SET type = '" . $this->db->escape($data['type']) . "', column_table = '" . $this->db->escape($data['column_table']) . "', sort_order = '" . (int)$data['sort_order'] . "'");
		...
		if (isset($data['option_value'])) {
			foreach ($data['option_value'] as $option_value) {
				...
				foreach ($option_value['option_value_description'] as $language_id => $option_value_description) {
					$this->db->query("INSERT INTO " . DB_PREFIX . "option_value_description SET option_value_id = '" . (int)$option_value_id . "', language_id = '" . (int)$language_id . "', option_id = '" . (int)$option_id . "', name = '" . $this->db->escape($option_value_description['name']) . "', color = '" . $this->db->escape($option_value_description['color']) . "', heading = '" . $this->db->escape($option_value_description['heading']) . "'");
				}
			}
		}
	...
	public function editOption($option_id, $data) {
		$this->db->query("UPDATE `" . DB_PREFIX . "option` SET type = '" . $this->db->escape($data['type']) . "', column_table = '" . $this->db->escape($data['column_table']) . "', sort_order = '" . (int)$data['sort_order'] . "' WHERE option_id = '" . (int)$option_id . "'");
	...
	$option_value_description_data[$option_value_description['language_id']] = array('name' => $option_value_description['name'],'color' => $option_value_description['color'], 'heading' => $option_value_description['heading']);
			}
