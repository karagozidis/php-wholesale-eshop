	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			if(isset($_POST['button-active'])){
				...
				$this->response->redirect($this->url->link('extension/module/fastor&submit=true&store_id=' . $data['store_id'] . '', 'user_token=' . $this->session->data['user_token'], true));
            }
		}
			...
			if(isset($_POST['button-save'])){
				if(is_writable(DIR_CATALOG . 'view/theme/fastor/skins') && is_writable(DIR_CATALOG . 'view/theme/fastor/skins/store_'.$data['edit_skin_store']) && is_writable(DIR_CATALOG . 'view/theme/fastor/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'])) {
					...
					if(file_exists(DIR_CATALOG . 'view/theme/fastor/skins/store_'.$data['edit_skin_store'].'/') && filetype(DIR_CATALOG . 'view/theme/fastor/skins/store_'.$data['edit_skin_store'].'/') == 'dir' && file_exists(DIR_CATALOG . 'view/theme/fastor/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'].'')) {
						...
						$this->session->data['success'] = $this->language->get('text_success');
						$this->response->redirect($this->url->link('extension/module/fastor&submit=true&store_id=' . $data['store_id'] . '&skin_edit=' . $data['active_skin_edit'] . '', 'user_token=' . $this->session->data['user_token'], true));
					}
				}
			...
			if(isset($_POST['button-save-live-editor'])){
				...
				if(is_writable(DIR_CATALOG . 'view/theme/fastor/skins') && is_writable(DIR_CATALOG . 'view/theme/fastor/skins/store_'.$data['edit_skin_store']) && is_writable(DIR_CATALOG . 'view/theme/fastor/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'])) {
					...
					if(file_exists(DIR_CATALOG . 'view/theme/fastor/skins/store_'.$data['edit_skin_store'].'/') && filetype(DIR_CATALOG . 'view/theme/fastor/skins/store_'.$data['edit_skin_store'].'/') == 'dir' && file_exists(DIR_CATALOG . 'view/theme/fastor/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'].'')) {
						...
						// Informacja o zapisaniu ustawien
						$this->session->data['success'] = $this->language->get('text_success');
						$this->response->redirect($this->url->link('extension/module/fastor&submit=true&store_id=' . $data['store_id'] . '&skin_edit=' . $data['active_skin_edit'] . '', 'live_editor=true&store_id='.$data['store_id'].'&user_token=' . $this->session->data['user_token'], true));
					}
				}
				
				// Jezeli nie istnieje katalog skorki to pojawia sie komunikat o bledzie
				$this->session->data['error_warning'] = 'You need to set CHMOD 777 for all folder and subfolder in catalog/view/theme/fastor/skins!';
				$this->response->redirect($this->url->link('extension/module/fastor&submit=true&store_id=' . $data['store_id'] . '', 'live_editor=true&store_id='.$data['store_id'].'&user_token=' . $this->session->data['user_token'], true));
			}
		}
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {	
		     ...
		     if(isset($_POST['install_advanced_grid'])){
		     	...
		     	$this->session->data['success'] = $this->language->get('text_success');
		     	$this->response->redirect($this->url->link('extension/module/fastor', 'user_token=' . $this->session->data['user_token'], true));
		     }
		...
		$data['action'] = $this->url->link('extension/module/fastor', 'user_token=' . $this->session->data['user_token'], true);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/fastor', 'user_token=' . $this->session->data['user_token'], true)
		);
        ...
        $data['live_editor_link'] = $this->url->link('extension/module/fastor', 'live_editor=true&store_id='.$data['store_id'].'&user_token=' . $this->session->data['user_token'], true);
		$data['theme_options_link'] = $this->url->link('extension/module/fastor', 'store_id='.$data['store_id'].'&user_token=' . $this->session->data['user_token'], true);	
        
        if(!isset($this->request->get['live_editor'])){
            $data['header'] = $this->load->controller('common/header');
            $data['column_left'] = $this->load->controller('common/column_leftSec');
