...
class ControllerExtensionModuleProductBlocks extends Controller {
	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/product_blocks', 'user_token=' . $this->session->data['user_token'], true));
		}
		...
		$data['action'] = $this->url->link('extension/module/product_blocks', 'user_token=' . $this->session->data['user_token'], true);
		...
		$data['breadcrumbs'][] = array(
			'text' => 'Product Blocks',
			'href' => $this->url->link('extension/module/product_blocks', 'user_token=' . $this->session->data['user_token'], true)
		);
