<?php
class ControllerCommonColumnLeftSec extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			//echo "ssss";//  $this->url->link('extension/module/filter_product', 'user_token=' . $this->session->data['user_token'], true);
			$data['custom_menu1'] =  $this->url->link('extension/module/filter_product', 'user_token=' . $this->session->data['user_token'], true);
	    	$data['SecMenu'] = $this->url->link('catalog/filterOrderBy', 'user_token=' . $this->session->data['user_token'], true);
            $data['ThirdMenu'] = $this->url->link('catalog/filter/edit&filter_group_id=8', 'user_token=' . $this->session->data['user_token'], true);
			$data['FourthMenu'] = $this->url->link('extension/module/megamenu&module_id=0&edit=4', 'user_token=' . $this->session->data['user_token'], true);
