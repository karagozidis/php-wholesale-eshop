...
class ControllerCatalogProduct extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            if (isset($this->request->get['filter_campaign'])) {
				$url .= '&filter_campaign=' . urlencode(html_entity_decode($this->request->get['filter_campaign'], ENT_QUOTES, 'UTF-8'));
			}
            ...
            if (isset($this->request->get['filter_quantity2'])) {
				$url .= '&filter_quantity2=' . $this->request->get['filter_quantity2'];
            }
	...
	protected function getList() {
        ...
        if (isset($this->request->get['filter_quantity2'])) {
			$filter_quantity2 = $this->request->get['filter_quantity2'];
		} else {
			$filter_quantity2 = '';
        }
		...
		$filter_data = array(
            ...
            'filter_quantity2' => $filter_quantity2,
        ...
        $data['filter_quantity2'] = $filter_quantity2;
	...
	protected function getForm() {
		...
		foreach ($data['product_options'] as $product_option) {
			if ($product_option['type'] == 'select' || $product_option['type'] == 'option_qty' || $product_option['type'] == 'radio' || $product_option['type'] == 'checkbox' || $product_option['type'] == 'image') {
		...
		foreach ($product_images as $product_image) {
			...
			$data['product_images'][] = array(
                ...
                'imgHex' =>  $product_image['imgHex'],
                'imgLbl' =>  $product_image['imgLbl']
			);
		}
