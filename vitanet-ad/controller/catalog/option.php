...
class ControllerCatalogOption extends Controller {
	...
	public function index() {
		...
		$query = $this->db->query("DESC " . DB_PREFIX . "option_value_description");
				if (!$query->num_rows) {
					$this->db->query("ALTER TABLE " . DB_PREFIX . "option_value_description ADD heading TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL");
				}
	...
	protected function getForm() {
		...
		if (isset($this->request->post['column_table'])) {
			$data['column_table'] = $this->request->post['column_table'];
		} elseif (!empty($option_info)) {
			$data['column_table'] = $option_info['column_table'];
		} else {
			$data['column_table'] = '';
		}
	...
	protected function validateForm() {
		...
		if (($this->request->post['column_table'] == 'column_1' || $this->request->post['column_table'] == 'columns_2' || $this->request->post['column_table'] == 'columns_3' || $this->request->post['column_table'] == 'columns_4' || $this->request->post['column_table'] == 'columns_5' || $this->request->post['column_table'] == 'columns_6' || $this->request->post['column_table'] == 'columns_7' || $this->request->post['column_table'] == 'columns_8') && !isset($this->request->post['option_value'])) {
	...
	public function autocomplete() {
		...
		if (isset($this->request->get['filter_name'])) {
			...
			foreach ($options as $option) {
				...
				if ($option['type'] == 'select' || $option['type'] == 'option_qty' || $option['type'] == 'radio' || $option['type'] == 'checkbox' || $option['type'] == 'image') {
				...
				if ($option['column_table'] == 'column_1' || $option['column_table'] == 'columns_2' || $option['column_table'] == 'columns_3' || $option['column_table'] == 'columns_4' || $option['column_table'] == 'columns_5' || $option['column_table'] == 'columns_6' || $option['column_table'] == 'columns_7' || $option['column_table'] == 'columns_8') {
					$type = $this->language->get('text_choose');
				}
				
				$type = '';

				if ($option['type'] == 'select' || $option['type'] == 'option_qty' || $option['type'] == 'radio' || $option['type'] == 'checkbox') {
					$type = $this->language->get('text_choose');
				}
				...
				$json[] = array(
					...
					'category'     => $type,	
					'column_table'         => $option['column_table'],
					'type'         => $option['type'],
