...
class ControllerCustomerCustomer extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['discountpercnt'])) {
			$data['discountpercnt'] = $this->request->post['discountpercnt'];
		} elseif (!empty($customer_info)) {
			$data['discountpercnt'] = $customer_info['discountpercnt'];
		} else {
			$data['discountpercnt'] = 0;
		}
		
		if (isset($this->request->post['softone_code'])) {
			$data['softone_code'] = $this->request->post['softone_code'];
		} elseif (!empty($customer_info)) {
			$data['softone_code'] = $customer_info['softone_code'];
		} else {
			$data['softone_code'] = '';
		}
