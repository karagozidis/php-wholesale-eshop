<?php
class ControllerAccounts1order extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('account/s1order', $url, true)
		);
		...
		$order_total = $this->model_account_order->getTotals1Orders();

		$results = $this->model_account_order->gets1Orders();
		...
		$this->response->setOutput($this->load->view('account/s1order_list', $data));
	}
