				      ...
				      <div class="col-sm-12">
				           <div class="overflow-thumbnails-carousel clearfix">
     					      <div class="thumbnails-carousel owl-carousel">
     						     ...
     						     <?php foreach ($images as $image) { ?>
								   <?php if ($image['popup'] != "") { ?>
     						         <div class="itemColor citem<?php echo str_replace("#","",$image['imgHex']); ?>">
			    ...
			    <div style="margin-top: 5px;" class="col-sm-<?php echo $product_center_grid; ?> product-center clearfix">
			     <div itemscope itemtype="http://schema.org/Offer">
			      ...
			      <div class="description" style="padding: 24px 0px 10px 0px;">
					...
					<span style="width: 80px;"><?php echo $text_price; ?></span> 
					
					 <?php if (!$special) { ?>
						<?php echo $price; ?>
					 <?php } else { ?> 

					 <span style="width: 60px;padding: 0px;margin: 0px;">  <?php echo $special;  ?> </span>
					 <span style="text-decoration: line-through; color: #5a5a5a; width: 50%; font-size: 12px;">  	<?php echo $price; ?> </span>
					 <?php } ?>  
								   ...
								   <?php if ( $image['imgHex'] != "" ) { ?>
											...
											$( "#ColorHex<?php echo str_replace("#","",$image['imgHex']); ?>" ).click(function() {
												...
												if(curColor != '<?php echo str_replace("#","",$image['imgHex']); ?>') 
												{
													...
													$( ".itemColor" ).hide();
													$( ".citem<?php echo str_replace("#","",$image['imgHex']); ?>" ).show();
                                                ...
                                                $( ".thumbnails-carousel" ).effect( "bounce", {times:3}, 300 );
