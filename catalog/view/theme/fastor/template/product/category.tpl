...
<div id="mfilter-content-container">
  ...
  <!-- Filter -->
  <div class="product-filter clearfix" style="border: 1px solid #e5e5e5;border-bottom: 2px solid #13A697;" >
  	<div class="options">
  ...
  <!-- Products list -->
  <div class="product-list active" style="border-right: 1px solid #e5e5e5;border-left: 1px solid #e5e5e5;">
  ...
  ?>
  <div class="product-grid active" style="border-right: 1px solid #e5e5e5;border-left: 1px solid #e5e5e5;">
  	<div class="row">
