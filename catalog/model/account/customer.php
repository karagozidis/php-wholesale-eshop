...
class ModelAccountCustomer extends Model {
	...
	public function getrelCustomers() {
		
		$sql =  	
			"SELECT cuscode as cuscode , relcode as relcode , relname as relname".
			" FROM " . DB_PREFIX . "s1related ".
			" WHERE cuscode = (SELECT softone_code from " . DB_PREFIX . "customer WHERE customer_id = '" . (int)$this->customer->getId() . "') ".
			" AND cuscode != '' ";
